...
export const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    try {
      ...
      // LLAMADA REAL al backend para subir el archivo
      ...
      if (response.success && response.data) {
        ...
        // Llamar al callback con la información del servidor
        onFileUpload(
        ...
        throw new Error(response.error?.message || 'Error al subir el archivo');
      }
    } catch (err: any) {
